...
#     Download Oracle Business Intelligence 12.2.1.0.0 for Linux x64
...
COPY $INSTALL_FILE_RSP_WLS $INSTALL_FILE_RSP_BI $INSTALL_FILE_RSP_CONFIG $RUN_FILE _configureOBIEE.sh _dropRCU.sh $ORACLE_BASE/
